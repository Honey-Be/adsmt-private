...
v0.1 was wired up. Confirmed 2026-05-13 when bumping logicutils to
v0.5.0 alongside the adsmt v0.3 cycle (option C: surface relevant
v0.3 features in lu-kb).
